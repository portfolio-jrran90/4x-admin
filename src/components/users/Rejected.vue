<template>
  <div>
    ...
    | =============================================================================
    -->
    <!-- <b-modal v-model="modalUserShow" size="95" title="[Rejected] User Detail"
      hide-footer>
    ...
    <b-modal v-model="modalUserShow" modal-class="modal-pending-steps" size="95" title="Rejected Users"
      hide-footer
      no-close-on-esc
